...
Follow `.myagents/commands/workflow.md` strictly.

Mandatory rules:

1. Do not inspect source files, search the repo, run implementation commands, or edit code until Step 1 and Step 2 from `.myagents/commands/workflow.md` are completed.
...
6. The final output must include the DoD check report in Japanese, as required by `.myagents/commands/workflow.md`.
